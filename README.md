# 📦 Sistema de Controle de Estoque - Loja de Elétrica
...
🌐 **Acesse a aplicação rodando online:** [Clique aqui para abrir no Replit(https://estoqueeletrica--salatielfreitas.replit.app)
